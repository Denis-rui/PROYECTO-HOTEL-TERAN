...
class Auth
{
    ...
    private const PERMISOS_POR_ACCION = [
        'Reserva' => [
            ...
            'validarDevolucionPago' => 'pagos.registrar',
            'registrarDevolucionPago' => 'pagos.registrar',
            'checkin' => 'reservas.checkin',
            'preCheckin' => 'reservas.checkin',
            ...
            'eliminarPendiente' => 'reservas.cancelar',
        ...
        'Habitacion' => [
            ...
            'notificarLimpiezaVencida' => 'habitaciones.cambiar_estado',
            'extenderLimpieza' => 'habitaciones.cambiar_estado',
        ],
        'Cliente' => [
